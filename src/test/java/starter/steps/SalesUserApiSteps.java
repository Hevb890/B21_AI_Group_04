...
public class SalesUserApiSteps {
    ...
    public void getPaginatedSales() {
        ...
        // Verify paginated response structure from PageSale schema
        assertThat(response.jsonPath().get("content") != null)
                .as("Response should contain content field").isTrue();
        assertThat(response.jsonPath().get("totalElements") != null)
                .as("Response should contain totalElements field").isTrue();
    ...
    public void getPaginatedSalesSorted(String sortField, String sortDir) {
        ...
        assertThat(response.statusCode())
                .as("Paginated sales with sort " + sortField + " " + sortDir
                        + " should return 200")
                .isEqualTo(200);

        assertThat(response.jsonPath().get("content") != null)
                .as("Response should contain content").isTrue();

        System.out.println("[SalesUserApiSteps] Paginated sales retrieved sorted by "
                + sortField + " " + sortDir);
    }
